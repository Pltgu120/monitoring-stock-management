@extends('layouts.app')
@section('title', __("Edit Sparepart Consumable Part PLTGU Tanjung Uncang"))
@section('content')
<x-head-datatable/>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="part_name" class="form-control" value="{{ $item->part_name }}" required>
                                </div>

                                <div class="form-group">
                                    <label for="part_number" class="form-label">{{ __("Part Number") }} <span class="text-danger">*</span></label>
                                    <input type="text" name="part_number" class="form-control" value="{{ $item->part_number }}" required>
                                </div>

                                <div class="form-group">
                                    <label for="kode_rak" class="form-label">{{ __("Kode Rak") }} <span class="text-danger">*</span></label>
                                    <input type="text" name="kode_rak" class="form-control" value="{{ $item->kode_rak }}" required>
                                </div>

                                <div class="form-group">
                                    <label for="date_items" class="form-label">{{ __("Keterangan") }} <span class="text-danger">*</span></label>
                                    <input type="date" name="date_items" class="form-control" value="{{ $item->date_items }}" required>
                                </div>

                                <div class="form-group">
                                    <label for="person_name" class="form-label">{{ __("Person Name") }} <span class="text-danger">*</span></label>
                                    <input type="text" name="person_name" class="form-control" value="{{ $item->person_name }}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="brand_name" class="form-control" value="{{ $item->brand_name }}" required>
                                </div>
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <input type="text" id="price" name="price" class="form-control" value="{{ $item->price }}" placeholder="RP. 0" required>
                                </div> --}}
