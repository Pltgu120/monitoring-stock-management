@extends('layouts.app')
@section('title', __("Data Sparepart Consumable Part PLTGU Tanjung Uncang"))
@section('content')
<x-head-datatable/>
                ...
                <div class="card-header row">
                    <div class="d-flex justify-content-between align-items-center w-100">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="{{ route('barang.template') }}" class="btn btn-outline-success btn-sm font-weight-bold m-1">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date_items" class="form-control">
                                        </div>
...
<script>
...

            {
                ...
                render: function (data, type, row, meta) {
                    if (data) {
                        ...
                        let pdfUrl = "{{ asset('storage/pdf_files/') }}/" + data; // Lokasi file PDF
                        ...
                        // let noFileIconUrl = "{{ asset('images/no_pdf.png') }}"; // Lokasi ikon untuk 'tidak ada file'
                        return "No files";
                    }
                },
                orderable: false,
    ...
    // Form.append('code', $("input[name='kode']").val());
    // Form.append('name', $("input[name='nama']").val());
    // Form.append('category_id', $("select[name='jenisbarang']").val());
    // Form.append('unit_id', $("select[name='satuan']").val());
    // Form.append('brand_id', $("select[name='merk']").val());
    // Form.append('price', $("input[name='harga']").val());
    ...
    Form.append('date_items', $("input[name='date_items']").val());
...
$(document).ready(function() {
    ...
    $("#modal-button").on("click", function() {
        ...
        $("input[name='date_items']").val(null);
