@extends('layouts.app')
@section('title', __("Data Chemical PLTGU Tanjung Uncang"))
@section('content')
<x-head-datatable/>
                    ...
                    <div class="d-flex justify-content-between align-items-center w-100">
                        ...
                        <div class="d-flex">
                            @if(Auth::user()->role->name != 'staff')
                                <a href="{{ route('barang-kimia.template') }}" class="btn btn-outline-success btn-sm font-weight-bold m-1">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date_items_chemical" class="form-control">
                                        </div>
...
<div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('barang-kimia.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="file">{{ __("Choose Excel File") }}</label>
                        <input type="file" name="file" class="form-control" required>
...
<script>
    ...
    $('#data-tabel').DataTable({
        ...
        columns: [
            ...
            {
                data: 'date_items_chemical',
                name: 'date_items_chemical',
                render: function (data) {
                    if (data) {
...

            {
                ...
                render: function (data, type, row, meta) {
                    if (data) {
                        ...
                        let pdfUrl = "{{ asset('storage/pdf_files_kimia/') }}/" + data; // Lokasi file PDF
                    ...
                    return ''; // Kosong jika tidak ada file PDF
                },
                orderable: false,
                searchable: false
            },
    ...
    function simpan() {
        ...
        Form.append('date_items_chemical', $("input[name='date_items_chemical']").val());
...
function resetForm() {
    ...
    $("input[name='date_items_chemical']").val('');
...
$(document).ready(function() {
    ...
    $("#modal-button").on("click", function() {
        ...
        $("input[name='date_items_chemical']").val(null);
