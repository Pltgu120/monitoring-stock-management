@extends('layouts.app')
@section('title', __("Data Barang Bekas Pakai Mekanik PLTGU Tanjung Uncang"))
@section('content')
<x-head-datatable/>
...
<script>
    ...
    $('#data-tabel').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: `{{ route('barang-bekas-pakai-mekanik.list') }}`,
        columns: [
            {
    ...
    $.ajax({
        url: `{{ route('barang-bekas-pakai-mekanik.save') }}`,
        type: "POST",
        data: Form,
        processData: false,
        contentType: false,
