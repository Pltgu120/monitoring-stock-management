@extends('layouts.app')
@section('title', __("Detail Barang Mekanik PLTGU Tanjung Uncang"))
@section('content')
<x-head-datatable/>
                ...
                <div class="card-body">
                    {{-- <form action="{{ route('barang.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="part_name" class="form-control" value="{{ $itemMechanical->part_name }}" required readonly>
                                </div>

                                <div class="form-group">
                                    <label for="part_number" class="form-label">{{ __("Part Number") }} <span class="text-danger">*</span></label>
                                    <input type="text" name="part_number" class="form-control" value="{{ $itemMechanical->part_number }}" required readonly>
                                </div>

                                <div class="form-group">
                                    <label for="kode_rak" class="form-label">{{ __("Kode Rak") }} <span class="text-danger">*</span></label>
                                    <input type="text" name="kode_rak" class="form-control" value="{{ $itemMechanical->kode_rak }}" required readonly>
                                </div>

                                <div class="form-group">
                                    <label for="date_items_mechanical" class="form-label">{{ __("Keterangan") }} <span class="text-danger">*</span></label>
                                    <input type="date" name="date_items_mechanical" class="form-control" value="{{ $itemMechanical->date_items_mechanical }}" required readonly> 
                                </div>

                                <div class="form-group">
                                    <label for="person_name" class="form-label">{{ __("Person Name") }} <span class="text-danger">*</span></label>
                                    <input type="text" name="person_name" class="form-control" value="{{ $itemMechanical->person_name }}" required readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="unit_name" class="form-control" value="{{ $itemMechanical->unit_name }}" min="0" required readonly>
                                </div>

                                <div class="form-group">
                                    <label for="brand_name" class="form-label">{{ __("Brand Name") }} <span class="text-danger">*</span></label>
                                    <input type="text" name="brand_name" class="form-control" value="{{ $itemMechanical->brand_name }}" min="0" required readonly>
                                </div>

                                <div class="form-group">
                                    <label for="initial_qty" class="form-label">{{ __("Initial Quantity") }} <span class="text-danger">*</span></label>
                                    <input type="number" name="initial_qty" class="form-control" value="{{ $itemMechanical->initial_qty }}" min="0" required readonly>
                                </div>

                                <div class="form-group">
                                    <label for="quantity" class="form-label">{{ __("Quantity") }} <span class="text-danger">*</span></label>
                                    <input type="number" name="quantity" class="form-control" value="{{ $itemMechanical->quantity }}" min="0" required readonly>
                                </div>
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    @if($itemMechanical->image)
                                        <embed src="{{ asset('storage/barang_mekanik/' . $itemMechanical->image) }}" width="100%" height="300px" class="mb-2" />
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- Display the existing PDF file if available -->
                                    @if($itemMechanical->file_reference)
                                        <embed src="{{ asset('storage/pdf_files_mekanik/' . $itemMechanical->file_reference) }}" width="100%" height="300px" class="mb-2" />
                                    @endif
                        ...
                        <div class="modal-footer">
                            <a href="{{ route('barang-mekanik') }}" class="btn btn-secondary">{{ __("Back") }}</a>
