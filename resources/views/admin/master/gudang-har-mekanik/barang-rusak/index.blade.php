@extends('layouts.app')
@section('title', __("Data Barang Rusak Mekanik PLTGU Tanjung Uncang"))
@section('content')
<x-head-datatable/>
            ...
            <div class="card w-100">
                <div class="card-header row">
                    <div class="d-flex justify-content-between align-items-center w-100">
                            ...
                            {{-- <a href="{{ route('barang-rusak.export') }}" class="btn btn-outline-success font-weight-bold m-1">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date_damaged_items" class="form-control">
                                        </div>
...
<script>
    ...
    $('#data-tabel').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: `{{ route('barang-rusak-mekanik.list') }}`,
        columns: [
            {
            ...
            {
                data: 'date_damaged_items',
                name: 'date_damaged_items',
                render: function (data) {
                    if (data) {
                        // Ubah format tanggal
                        const date = new Date(data);
                        const options = { day: 'numeric', month: 'long', year: 'numeric', locale: 'id-ID' };
                        return date.toLocaleDateString('id-ID', options); // Format ke 28 Februari 1976
                    }
    ...
    Form.append('date_damaged_items', $("input[name='date_damaged_items']").val());
    ...
    $.ajax({
        url: `{{ route('barang-rusak-mekanik.save') }}`,
        type: "POST",
        data: Form,
        processData: false,
        contentType: false,
...
function resetForm() {
    ...
    $("input[name='date_damaged_items']").val('');
...
$(document).ready(function() {
    ...
    $("#modal-button").on("click", function() {
        ...
        $("input[name='date_damaged_items']").val(null);
